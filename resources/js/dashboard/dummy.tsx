            ...
            case 'role':
                return (
                    <div className="flex flex-col">
                        ...
                        <p className="text-bold text-tiny text-default-400 capitalize">{user.team}</p>
                    </div>
                );
            case 'status':
                return (
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <label className="text-default-400 text-small flex items-center">
                        Rows per page:
                        <select className="text-default-400 text-small bg-transparent outline-none" onChange={onRowsPerPageChange}>
